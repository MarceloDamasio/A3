...
export function EditableExerciseSection({
  title,
  icon,
  exercises,
  onUpdate,
  ...
  const handleAddExercise = () => {
    if (newExercise.trim()) {
      const updated = [...localExercises, newExercise.trim()];
                ...
                <>
                  ...
                  {isEditing && (
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => handleStartEdit(index, exercise)}
